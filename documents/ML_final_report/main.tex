...
& &
-- Thu thập dữ liệu từ Kaggle/Roboflow. \\
& &
-- Viết script tiền xử lý dữ liệu (Resize, chuẩn hóa nhãn). \\
& &
-- Soạn thảo Báo cáo Dữ liệu (Data Report).
\\
\hline
Phan Hoàng Quang Nghị & 23127436 &
-- Nghiên cứu các kiến trúc mô hình (YOLOv8, YOLOv10, RT-DETR). \\
& &
-- Thực hiện huấn luyện mô hình (Training) và tinh chỉnh tham số. \\
& &
-- Vẽ biểu đồ và phân tích kết quả thực nghiệm. \\
& &
-- Soạn thảo Báo cáo Mô hình (Model Report).
\\
\hline
Nguyễn Tấn Văn & 23127515 &
-- Xây dựng ứng dụng Demo (Web App/Deployment). \\
& &
-- Tích hợp API cảnh báo (Telegram/Zalo). \\
& &
-- Tổng hợp tài liệu và biên soạn Slide báo cáo cuối kỳ. \\
& &
